<%-- 
    Document   : loginerror
    Created on : 19/01/2024, 17:46:53
    Author     : jos56
--%>
...
<head>
    ...
    <title>Consultorio Odontologica - Login</title>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="SV_Login" method="POST">
                                        <h2>Usuario Incorrecto</h2>
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="exampleInputEmail" aria-describedby="emailHelp"
                                                placeholder="Nombre de Usuario" name="nombreusu">
                                        </div>
                                        <div class="form-group">
